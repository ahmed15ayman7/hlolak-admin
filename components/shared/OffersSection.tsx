...
const OffersSection = ({
  ...
  return (
    <section className="blog text-[#000000] body-font mb-10">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-[#b7bac1]">
          العروض العقارية          </h1>
          <div className="flex">
            <Button
              variant={"link"}
